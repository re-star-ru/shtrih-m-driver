...
func readSerial() {
	...
	println("isConfigured:", fsStatusByte&1)
	println("isFiscalModeOpened:", fsStatusByte&2)
	println("isFiscalModeClosed:", fsStatusByte&4)
	println("isTransferCompleted:", fsStatusByte&8)
	println()

	//isConfigured = BitUtils.testBit((long)this.code, 0)
	//isFiscalModeOpened = BitUtils.testBit((long)this.code, 1)
	//isFiscalModeClosed = BitUtils.testBit((long)this.code, 2)
	//isTransferCompleted = BitUtils.testBit((long)this.code, 3)
	/////
